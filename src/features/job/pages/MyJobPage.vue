...
const statusColorMap: Record<string, string> = { open: 'green', draft: 'default', pending_approve: 'orange', paused: 'gold', on_hold: 'default', filled: 'blue', closed: 'red', expired: 'default', archived: 'default', duplicate: 'default', shadow: 'purple' }
const statusLabelMap: Record<string, string> = { open: '招聘中', draft: '草稿', pending_approve: '待审批', paused: '暂停', on_hold: '搁置', filled: '已招满', closed: '已关闭', expired: '已过期', archived: '已归档', duplicate: '重复', shadow: '保密岗' }
