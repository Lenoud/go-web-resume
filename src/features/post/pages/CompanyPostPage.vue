...
import {
  ...
  talentPoolAdd,
  type PostInfo,
  type PostCompanyListReq,
  type CreateInterviewReq,
  type CreateOfferReq,
  type InterviewInfo,
  type OfferInfo,
  type ResumeSnapshotInfo,
  type StatusLogInfo,
  type UpdateOfferReq,
  type UpdatePostReq,
} from '@/client'
...
const listQuery = useQuery({
  ...
  queryFn: async () => {
    const query: PostCompanyListReq = { page: page.value, pageSize: pageSize.value }
...
const updateMutation = useMutation({
  mutationFn: (body: UpdatePostReq) => postUpdate({ body }),
  onSuccess: () => {
