...
<template>
  ...
  >
    ...
    >
      ...
      <div
        v-show="!isRegister"
        class="relative text-center px-16 z-10"
      >
        <h2 class="text-4xl font-bold text-white m-0 mb-4 tracking-wider">
          欢迎回来
        </h2>
        <p class="text-white/65 text-sm leading-relaxed m-0 mb-10 max-w-xs mx-auto">
          登录你的账号，查看投递进度与最新岗位
        </p>
        <button
